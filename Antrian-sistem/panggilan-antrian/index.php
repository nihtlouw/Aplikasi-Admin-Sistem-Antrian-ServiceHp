...
<body class="d-flex flex-column h-100">
      ...
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="../index.php" target="_blank" ><i class="bi-house-fill text-success"></i></a></li>
        ...
        <div class="card-body p-4">
          <div class="table-responsive">
            ...
            <div class="container">
                    ...
                    <button class="btn btn-success" id="reset-antrian-btn">Reset Antrian</button>
                </div>
          </div>
        </div>
      </div>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#reset-antrian-btn').click(function() {
        // Lakukan tindakan reset antrian di sini
        // Contoh: mengirim permintaan AJAX ke server untuk mereset antrian
        $.ajax({
          type: "POST",
          url: "reset_antrian.php", // Ganti dengan URL yang benar untuk proses reset antrian
          success: function(response) {
            // Handle respon dari server jika diperlukan
            console.log(response); // Contoh: menampilkan respon server di konsol
          },
          error: function(error) {
            // Handle kesalahan jika ada
            console.error(error); // Contoh: menampilkan pesan kesalahan di konsol
          }
        });
      });
    });
